...
class ProfileView extends App.View {
  ...
  render() {
    ...
    return html`
        <div class="profile-container" @click="${this.navigateToEditPage}">
      <div class="profile-image-container">
        <img src="${this.profile.profileImageURL}" alt="Profile Image" class="profile-image">
      </div>
      <div class="profile-details">
        <div class="profile-name">${this.profile.firstName} ${this.profile.lastName}</div>
  ...
  getOrdersContent() {
    if (this.profile.orders.length === 0) {
